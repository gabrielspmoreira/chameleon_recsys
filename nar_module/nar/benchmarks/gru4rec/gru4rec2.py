...
class GRU4Rec:
    ...
    last_clicks_buffer_size: int
        Size of the Last N clicks buffer, used to provide recently clicked negative samples
    ...
    def update_last_clicks_items_buffer(self, items):
    ...
    def generate_neg_samples_from_last_clicks_buffer(self):
        ...
        np.random.shuffle(unique_items_buffer)
        neg_items = unique_items_buffer.flatten()[:self.n_sample]
        #Completing the expected number of samples with padding zeros, if necessary
